...
| FR1.1       | ПП надає інструменти та функціональні можливості для проведення аналізу безпеки робочого простору                                                                            |                                                                                                                      |
| FR1.2       | ПП генерує звіт з безпеки, що підсумовує результати аналізу безпеки.                                                                           |
| FR2         | Сформувати допоміжний пакет                                                                                                                     |                                                              
| FR2.1       | ПП надає інструменти та функціональні можливості для створення пакети підтримки для митців.                                                                                                 |
